...
CREATE TABLE geo.Tabela AS (SELECT * FROM geo.Pietro NATURAL JOIN geo.Epoka 
NATURAL JOIN geo.Okres NATURAL JOIN geo.Era NATURAL JOIN geo.Eon );
...
CREATE INDEX indx_T ON geo.Tabela(id_eon, id_era, id_epoka, id_okres);
--------------------------- usuwanie indeksow ---------------------------------

DROP INDEX indx_eon ON geo.Eon;
DROP INDEX indx_era ON geo.Era;
DROP INDEX indx_epoka ON geo.Epoka;
DROP INDEX indx_okres ON geo.Okres;
DROP INDEX indx_pietro ON geo.Pietro;
DROP INDEX indx_tabela ON geo.Tabela;

DROP INDEX indx_liczba ON geo.Milion;
DROP INDEX indx_cyfra ON geo.Dziesiec;

DROP INDEX indx_T ON geo.Tabela;
-------------------------------- test 1 ZL -----------------------------------
